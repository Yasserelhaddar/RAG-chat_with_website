...
if website_url is None or website_url == "":
    ...
    # Display sentiment analysis for the content of the webpage
    if "vector_store" in st.session_state:
        st.header("Sentiment Analysis of Webpage Content")
        vector_store = st.session_state.vector_store
        all_text = " ".join([doc.page_content for doc in vector_store.documents])
